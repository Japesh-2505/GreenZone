...
class ind{
 ...
 Sign_Up(json_obj) {
  ...
  function bgcolor()
  {
    button.style.backgroundColor = "#00bfa6";
  }
  function bgchange()
  {
  ...
  // img6.src = json_obj.img24;
  // img6.style.width = "5rem";
  // img6.style.height = "5rem";
  // img6.style.position = "absolute";
  // img6.style.top = "0.3rem";
  // img6.style.left = "0.3rem";
  // img6.style.backgroundColor = "#f2efea";
  // img6.style.borderRadius = "50%";
  // img6.style.padding = "0.2rem";
  // img6.style.cursor = "pointer";
  // img6.style.boxShadow = "-10px 10px 15px black";
  // img6.addEventListener("click" , ()=>{window.open("index.html" , "_self")});
